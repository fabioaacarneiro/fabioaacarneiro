...
## PHP
#### [ramtask.com](https://github.com/fabioaacarneiro/gestortarefas-laravel)

- https://ramtask.com é um projeto que surgiu da necessidade de organizar e estruturar meu afazeres do trabalho, faculdade, casa, coisas importantes como datas comemorativas, provas, prazos de projetos e mais. Com o simples conceito de aplicação To-Do é possível construir um gerenciamento pessoal de processos muito poderoso, a premissa por trás do desenvolvimento deste projeto tem como objetivo também melhorar minhas habilidades com PHP, Laravel no padrão MVC, o mais famoso no mundo e também com Bootstrap 5. Ainda está em desenvolvimento, o projeto usa dois serviços gratuitos, a hospedagem VPS da LocalWeb fazendo a parte de hospedar minha aplicação web em ambiente linux. Foi implementado um sistema simples de gameficação que leva em conta as tarefas concluídas, é possível criar listas de tarefas que agrupam tarefas para cumprir com várias finalidades, podendo adicionar uma descrição na mesma, e em cada tarefa além de editar o nome e sua descrição como no caso da lista de tarefas, é possível adicionar um comentário, que pode representar algo relevante para você no futuro. Ainda há muitas funcionalidades para serem implementadas e muito provavelmente eu tenha relatado aqui apenas uma fração de tudo que essa aplicação oferece, aguarde!

- acesse o site [RamTask](https://ramtask.com/)
